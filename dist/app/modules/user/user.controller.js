...
const getAllUserOrAgent = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const role = req.query.role;
    if (!role) {
        throw new AppError_1.default(400, "Role query parameter is required");
    }
    const users = yield user_service_1.UserServices.getAllUserOrAgent(role.toUpperCase());
    (0, sendResponse_1.sendResponse)(res, {
...
const approveAgent = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const createAgent = yield user_service_1.UserServices.approveAgent(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_codes_1.default.OK,
        success: true,
...
const suspendAgent = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const suspendAgent = yield user_service_1.UserServices.suspendAgent(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_codes_1.default.OK,
        success: true,
